 ...
 */
export interface SuperstreamClient {
  /**
   ...
   */
  readonly getCurrentTime: () => Promise<BN | null>;
  ...
  /**
   * Get a stream by public key. If such a stream doesn't exist, null is returned. If there is a Solana RPC issue, an
   * error is thrown.
   *
   * @returns The stream with the given public key or null if not found
   *
